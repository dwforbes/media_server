...
impl ObjectId {
    pub fn to_id(&self) -> String {
        ...
        match self {
            ...
            MoviesByFranchise => "mv:set".into(),
            MoviesFranchise(name) => format!("mv:set:{}", enc(name)),
    ...
    pub fn parse(id: &str) -> Option<ObjectId> {
        ...
        Some(match parts.as_slice() {
            ...
            ["mv", "set"] => MoviesByFranchise,
            ["mv", "set", n] => MoviesFranchise(dec(n)?),
